...
module "logic_app" {
    ...
    lg_primary_access_key = module.logic_app_storage.storageaccount_resource_properties["loggics"].key
    lg_storage_account_name = module.logic_app_storage.storageaccount_resource_properties["loggics"].name
